...
import com.example.android.miwok.ColoursFragment;
...
public class AdapterFragment extends FragmentPagerAdapter {
    ...
    private String[] tabTitles = {"Numbers","Family","Colours","Phrases"};
    ...
    AdapterFragment(FragmentManager fm, Context context) {
        super(fm);
    }
